...
public:
	...
	constexpr setena_f(uint32_t value) : m_value(value) {}
	constexpr operator uint32_t() const {return m_value;}
	constexpr operator iser3_r() const {return static_cast<uint32_t>(static_cast<uint32_t>(m_value) << Offset);}
	static constexpr auto get(iser3_r value) -> uint32_t { return static_cast<uint32_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<iser3_r>() const {return ClearSet<iser3_r>(Mask, *this);}
	constexpr auto operator|(iser3_r other) const -> iser3_r { return static_cast<iser3_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<iser3_r> other) const -> ClearSet<iser3_r> {return ClearSet<iser3_r>(iser3_r(Mask) | other.clear(), *this | other.set()); }
...
private:
	...
	constexpr iser3_r(uint32_t value) : m_value(value) {}
	constexpr auto operator |(iser3_r other) const -> iser3_r { return m_value | other.m_value; }
	constexpr auto operator ~() const -> iser3_r { return ~m_value; }
	[[nodiscard]] constexpr auto value() const -> uint32_t { return m_value; }
...
public:
	...
	constexpr clrena_f(uint32_t value) : m_value(value) {}
	constexpr operator uint32_t() const {return m_value;}
	constexpr operator icer3_r() const {return static_cast<uint32_t>(static_cast<uint32_t>(m_value) << Offset);}
	static constexpr auto get(icer3_r value) -> uint32_t { return static_cast<uint32_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<icer3_r>() const {return ClearSet<icer3_r>(Mask, *this);}
	constexpr auto operator|(icer3_r other) const -> icer3_r { return static_cast<icer3_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<icer3_r> other) const -> ClearSet<icer3_r> {return ClearSet<icer3_r>(icer3_r(Mask) | other.clear(), *this | other.set()); }
...
private:
	...
	constexpr icer3_r(uint32_t value) : m_value(value) {}
	constexpr auto operator |(icer3_r other) const -> icer3_r { return m_value | other.m_value; }
	constexpr auto operator ~() const -> icer3_r { return ~m_value; }
	[[nodiscard]] constexpr auto value() const -> uint32_t { return m_value; }
...
public:
	...
	constexpr setpend_f(uint32_t value) : m_value(value) {}
	constexpr operator uint32_t() const {return m_value;}
	constexpr operator ispr3_r() const {return static_cast<uint32_t>(static_cast<uint32_t>(m_value) << Offset);}
	static constexpr auto get(ispr3_r value) -> uint32_t { return static_cast<uint32_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<ispr3_r>() const {return ClearSet<ispr3_r>(Mask, *this);}
	constexpr auto operator|(ispr3_r other) const -> ispr3_r { return static_cast<ispr3_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<ispr3_r> other) const -> ClearSet<ispr3_r> {return ClearSet<ispr3_r>(ispr3_r(Mask) | other.clear(), *this | other.set()); }
...
private:
	...
	constexpr ispr3_r(uint32_t value) : m_value(value) {}
	constexpr auto operator |(ispr3_r other) const -> ispr3_r { return m_value | other.m_value; }
	constexpr auto operator ~() const -> ispr3_r { return ~m_value; }
	[[nodiscard]] constexpr auto value() const -> uint32_t { return m_value; }
...
public:
	...
	constexpr clrpend_f(uint32_t value) : m_value(value) {}
	constexpr operator uint32_t() const {return m_value;}
	constexpr operator icpr3_r() const {return static_cast<uint32_t>(static_cast<uint32_t>(m_value) << Offset);}
	static constexpr auto get(icpr3_r value) -> uint32_t { return static_cast<uint32_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<icpr3_r>() const {return ClearSet<icpr3_r>(Mask, *this);}
	constexpr auto operator|(icpr3_r other) const -> icpr3_r { return static_cast<icpr3_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<icpr3_r> other) const -> ClearSet<icpr3_r> {return ClearSet<icpr3_r>(icpr3_r(Mask) | other.clear(), *this | other.set()); }
...
private:
	...
	constexpr icpr3_r(uint32_t value) : m_value(value) {}
	constexpr auto operator |(icpr3_r other) const -> icpr3_r { return m_value | other.m_value; }
	constexpr auto operator ~() const -> icpr3_r { return ~m_value; }
	[[nodiscard]] constexpr auto value() const -> uint32_t { return m_value; }
...
public:
	...
	constexpr active_f(uint32_t value) : m_value(value) {}
	constexpr operator uint32_t() const {return m_value;}
	constexpr operator iabr3_r() const {return static_cast<uint32_t>(static_cast<uint32_t>(m_value) << Offset);}
	static constexpr auto get(iabr3_r value) -> uint32_t { return static_cast<uint32_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<iabr3_r>() const {return ClearSet<iabr3_r>(Mask, *this);}
	constexpr auto operator|(iabr3_r other) const -> iabr3_r { return static_cast<iabr3_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<iabr3_r> other) const -> ClearSet<iabr3_r> {return ClearSet<iabr3_r>(iabr3_r(Mask) | other.clear(), *this | other.set()); }
...
private:
	...
	constexpr iabr3_r(uint32_t value) : m_value(value) {}
	constexpr auto operator |(iabr3_r other) const -> iabr3_r { return m_value | other.m_value; }
	constexpr auto operator ~() const -> iabr3_r { return ~m_value; }
	[[nodiscard]] constexpr auto value() const -> uint32_t { return m_value; }

	static constexpr std::size_t Offset = 524;
	static constexpr uint32_t ResetValue = 0; // 0 0x0
...
public:
	...
	constexpr ipr_n0_f(uint8_t value) : m_value(value) {}
	constexpr operator uint8_t() const {return m_value;}
	constexpr operator ipr20_r() const {return static_cast<uint8_t>(static_cast<uint8_t>(m_value) << Offset);}
	static constexpr auto get(ipr20_r value) -> uint8_t { return static_cast<uint8_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<ipr20_r>() const {return ClearSet<ipr20_r>(Mask, *this);}
	constexpr auto operator|(ipr20_r other) const -> ipr20_r { return static_cast<ipr20_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<ipr20_r> other) const -> ClearSet<ipr20_r> {return ClearSet<ipr20_r>(ipr20_r(Mask) | other.clear(), *this | other.set()); }
...
public:
	...
	constexpr ipr_n1_f(uint8_t value) : m_value(value) {}
	constexpr operator uint8_t() const {return m_value;}
	constexpr operator ipr20_r() const {return static_cast<uint16_t>(static_cast<uint16_t>(m_value) << Offset);}
	static constexpr auto get(ipr20_r value) -> uint8_t { return static_cast<uint8_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<ipr20_r>() const {return ClearSet<ipr20_r>(Mask, *this);}
	constexpr auto operator|(ipr20_r other) const -> ipr20_r { return static_cast<ipr20_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<ipr20_r> other) const -> ClearSet<ipr20_r> {return ClearSet<ipr20_r>(ipr20_r(Mask) | other.clear(), *this | other.set()); }
...
public:
	...
	constexpr ipr_n2_f(uint8_t value) : m_value(value) {}
	constexpr operator uint8_t() const {return m_value;}
	constexpr operator ipr20_r() const {return static_cast<uint32_t>(static_cast<uint32_t>(m_value) << Offset);}
	static constexpr auto get(ipr20_r value) -> uint8_t { return static_cast<uint8_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<ipr20_r>() const {return ClearSet<ipr20_r>(Mask, *this);}
	constexpr auto operator|(ipr20_r other) const -> ipr20_r { return static_cast<ipr20_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<ipr20_r> other) const -> ClearSet<ipr20_r> {return ClearSet<ipr20_r>(ipr20_r(Mask) | other.clear(), *this | other.set()); }
...
private:
	...
	constexpr ipr20_r(uint32_t value) : m_value(value) {}
	constexpr auto operator |(ipr20_r other) const -> ipr20_r { return m_value | other.m_value; }
	constexpr auto operator ~() const -> ipr20_r { return ~m_value; }
	[[nodiscard]] constexpr auto value() const -> uint32_t { return m_value; }
...
public:
	...
	constexpr ipr21_r(uint32_t value) : m_value(value) {}
	constexpr auto operator |(ipr21_r other) const -> ipr21_r { return m_value | other.m_value; }
	constexpr auto operator ~() const -> ipr21_r { return ~m_value; }
	[[nodiscard]] constexpr auto value() const -> uint32_t { return m_value; }

	static constexpr std::size_t Offset = 852;
	static constexpr uint32_t ResetValue = 0; // 0 0x0
...
public:
	...
	constexpr ipr22_r(uint32_t value) : m_value(value) {}
	constexpr auto operator |(ipr22_r other) const -> ipr22_r { return m_value | other.m_value; }
	constexpr auto operator ~() const -> ipr22_r { return ~m_value; }
	[[nodiscard]] constexpr auto value() const -> uint32_t { return m_value; }

	static constexpr std::size_t Offset = 856;
	static constexpr uint32_t ResetValue = 0; // 0 0x0
...
public:
	...
	constexpr ipr23_r(uint32_t value) : m_value(value) {}
	constexpr auto operator |(ipr23_r other) const -> ipr23_r { return m_value | other.m_value; }
	constexpr auto operator ~() const -> ipr23_r { return ~m_value; }
	[[nodiscard]] constexpr auto value() const -> uint32_t { return m_value; }

	static constexpr std::size_t Offset = 860;
	static constexpr uint32_t ResetValue = 0; // 0 0x0
...
public:
	...
	constexpr ipr24_r(uint32_t value) : m_value(value) {}
	constexpr auto operator |(ipr24_r other) const -> ipr24_r { return m_value | other.m_value; }
	constexpr auto operator ~() const -> ipr24_r { return ~m_value; }
	[[nodiscard]] constexpr auto value() const -> uint32_t { return m_value; }
...
public:
	...
	constexpr ipr25_r(uint32_t value) : m_value(value) {}
	constexpr auto operator |(ipr25_r other) const -> ipr25_r { return m_value | other.m_value; }
	constexpr auto operator ~() const -> ipr25_r { return ~m_value; }
	[[nodiscard]] constexpr auto value() const -> uint32_t { return m_value; }

	static constexpr std::size_t Offset = 868;
	static constexpr uint32_t ResetValue = 0; // 0 0x0
...
private:
	...
	template<std::size_t Index> struct iser_r { static_assert(Index == 0 || Index == 1 || Index == 2 || Index == 3); };
	template<std::size_t Index> using iser_v = typename iser_r<Index>::type;
	template<std::size_t Index> constexpr auto& iser() { }

	template<std::size_t Index> struct icer_r { static_assert(Index == 0 || Index == 1 || Index == 2 || Index == 3); };
	template<std::size_t Index> using icer_v = typename icer_r<Index>::type;
	template<std::size_t Index> constexpr auto& icer() { }

	template<std::size_t Index> struct ispr_r { static_assert(Index == 0 || Index == 1 || Index == 2 || Index == 3); };
	template<std::size_t Index> using ispr_v = typename ispr_r<Index>::type;
	template<std::size_t Index> constexpr auto& ispr() { }

	template<std::size_t Index> struct icpr_r { static_assert(Index == 0 || Index == 1 || Index == 2 || Index == 3); };
	template<std::size_t Index> using icpr_v = typename icpr_r<Index>::type;
	template<std::size_t Index> constexpr auto& icpr() { }

	template<std::size_t Index> struct iabr_r { static_assert(Index == 0 || Index == 1 || Index == 2 || Index == 3); };
	template<std::size_t Index> using iabr_v = typename iabr_r<Index>::type;
	template<std::size_t Index> constexpr auto& iabr() { }

	template<std::size_t Index> struct ipr_r { static_assert(Index == 0 || Index == 1 || Index == 2 || Index == 3 || Index == 4 || Index == 5 || Index == 6 || Index == 7 || Index == 8 || Index == 9 || Index == 10 || Index == 11 || Index == 12 || Index == 13 || Index == 14 || Index == 15 || Index == 16 || Index == 17 || Index == 18 || Index == 19 || Index == 20 || Index == 21 || Index == 22 || Index == 23 || Index == 24 || Index == 25); };
	...
	Memory<uint32_t,ipr20_r> ipr20;
	Memory<uint32_t,ipr21_r> ipr21;
	Memory<uint32_t,ipr22_r> ipr22;
	Memory<uint32_t,ipr23_r> ipr23;
	Memory<uint32_t,ipr24_r> ipr24;
	Memory<uint32_t,ipr25_r> ipr25;
};
...
template<> struct nvic_p::ipr20_r::ipr_n_f<0> { using type = nvic_p::ipr20_r::ipr_n0_f; };
template<> struct nvic_p::ipr20_r::ipr_n_f<1> { using type = nvic_p::ipr20_r::ipr_n1_f; };
template<> struct nvic_p::ipr20_r::ipr_n_f<2> { using type = nvic_p::ipr20_r::ipr_n2_f; };
template<> struct nvic_p::ipr20_r::ipr_n_f<3> { using type = nvic_p::ipr20_r::ipr_n3_f; };
...
template<> constexpr auto& nvic_p::iser<3>() { return iser3; }
...
template<> struct nvic_p::iser_r<3> { using type = nvic_p::iser3_r; };
...
template<> constexpr auto& nvic_p::icer<3>() { return icer3; }
...
template<> struct nvic_p::icer_r<3> { using type = nvic_p::icer3_r; };
...
template<> constexpr auto& nvic_p::ispr<3>() { return ispr3; }
...
template<> struct nvic_p::ispr_r<3> { using type = nvic_p::ispr3_r; };
...
template<> constexpr auto& nvic_p::icpr<3>() { return icpr3; }
...
template<> struct nvic_p::icpr_r<3> { using type = nvic_p::icpr3_r; };
...
template<> constexpr auto& nvic_p::iabr<3>() { return iabr3; }
...
template<> struct nvic_p::iabr_r<3> { using type = nvic_p::iabr3_r; };
...
template<> constexpr auto& nvic_p::ipr<20>() { return ipr20; }
template<> constexpr auto& nvic_p::ipr<21>() { return ipr21; }
template<> constexpr auto& nvic_p::ipr<22>() { return ipr22; }
template<> constexpr auto& nvic_p::ipr<23>() { return ipr23; }
template<> constexpr auto& nvic_p::ipr<24>() { return ipr24; }
template<> constexpr auto& nvic_p::ipr<25>() { return ipr25; }
...
template<> struct nvic_p::ipr_r<20> { using type = nvic_p::ipr20_r; };
template<> struct nvic_p::ipr_r<21> { using type = nvic_p::ipr21_r; };
template<> struct nvic_p::ipr_r<22> { using type = nvic_p::ipr22_r; };
template<> struct nvic_p::ipr_r<23> { using type = nvic_p::ipr23_r; };
template<> struct nvic_p::ipr_r<24> { using type = nvic_p::ipr24_r; };
template<> struct nvic_p::ipr_r<25> { using type = nvic_p::ipr25_r; };
...
static_assert(offsetof(nvic_p, iser3) == nvic_p::iser3_r::Offset);
...
static_assert(offsetof(nvic_p, icer3) == nvic_p::icer3_r::Offset);
...
static_assert(offsetof(nvic_p, ispr3) == nvic_p::ispr3_r::Offset);
...
static_assert(offsetof(nvic_p, icpr3) == nvic_p::icpr3_r::Offset);
...
static_assert(offsetof(nvic_p, iabr3) == nvic_p::iabr3_r::Offset);
...
static_assert(offsetof(nvic_p, ipr20) == nvic_p::ipr20_r::Offset);
static_assert(offsetof(nvic_p, ipr21) == nvic_p::ipr21_r::Offset);
static_assert(offsetof(nvic_p, ipr22) == nvic_p::ipr22_r::Offset);
static_assert(offsetof(nvic_p, ipr23) == nvic_p::ipr23_r::Offset);
static_assert(offsetof(nvic_p, ipr24) == nvic_p::ipr24_r::Offset);
static_assert(offsetof(nvic_p, ipr25) == nvic_p::ipr25_r::Offset);
