...
public:
	...
	constexpr nssp_f(bool value = true) : m_value(value) {}
	constexpr operator bool() const {return m_value;}
	constexpr operator cr2_r() const {return m_value ? Mask : 0;}
	static constexpr auto get(cr2_r value) -> bool { return static_cast<bool>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<cr2_r>() const {return ClearSet<cr2_r>(Mask, *this);}
...
public:
	...
	constexpr frxth_f(bool value = true) : m_value(value) {}
	constexpr operator bool() const {return m_value;}
	constexpr operator cr2_r() const {return m_value ? Mask : 0;}
	static constexpr auto get(cr2_r value) -> bool { return static_cast<bool>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<cr2_r>() const {return ClearSet<cr2_r>(Mask, *this);}
...
public:
	...
	constexpr ldma_rx_f(bool value = true) : m_value(value) {}
	constexpr operator bool() const {return m_value;}
	constexpr operator cr2_r() const {return m_value ? Mask : 0;}
	static constexpr auto get(cr2_r value) -> bool { return static_cast<bool>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<cr2_r>() const {return ClearSet<cr2_r>(Mask, *this);}
...
public:
	...
	constexpr ldma_tx_f(bool value = true) : m_value(value) {}
	constexpr operator bool() const {return m_value;}
	constexpr operator cr2_r() const {return m_value ? Mask : 0;}
	static constexpr auto get(cr2_r value) -> bool { return static_cast<bool>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<cr2_r>() const {return ClearSet<cr2_r>(Mask, *this);}
...
private:
	...
	[[nodiscard]] constexpr auto nssp() const -> nssp_f {return nssp_f((m_value & nssp_f::Mask) != 0);}
	...
	[[nodiscard]] constexpr auto frxth() const -> frxth_f {return frxth_f((m_value & frxth_f::Mask) != 0);}
	[[nodiscard]] constexpr auto ldma_rx() const -> ldma_rx_f {return ldma_rx_f((m_value & ldma_rx_f::Mask) != 0);}
	[[nodiscard]] constexpr auto ldma_tx() const -> ldma_tx_f {return ldma_tx_f((m_value & ldma_tx_f::Mask) != 0);}
	...
	static constexpr std::size_t Offset = 4;
	static constexpr uint32_t ResetValue = 0b11100000000; // 1792 0x700
...
public:
	...
	constexpr frlvl_f(uint8_t value) : m_value(value & Range) {}
	constexpr operator uint8_t() const {return m_value;}
...
public:
	...
	constexpr ftlvl_f(uint8_t value) : m_value(value & Range) {}
	constexpr operator uint8_t() const {return m_value;}
	constexpr operator sr_r() const {return static_cast<uint16_t>(static_cast<uint16_t>(m_value) << Offset);}
	static constexpr auto get(sr_r value) -> uint8_t { return static_cast<uint8_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<sr_r>() const {return ClearSet<sr_r>(Mask, *this);}
...
private:
	...
	[[nodiscard]] constexpr auto frlvl() const -> frlvl_f {return frlvl_f(static_cast<uint8_t>(m_value >> frlvl_f::Offset));}
	[[nodiscard]] constexpr auto ftlvl() const -> ftlvl_f {return ftlvl_f(static_cast<uint8_t>(m_value >> ftlvl_f::Offset));}
...
public:
	...
	static constexpr auto get(crcpr_r value) -> uint16_t { return static_cast<uint16_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<crcpr_r>() const {return ClearSet<crcpr_r>(Mask, *this);}
	constexpr auto operator|(crcpr_r other) const -> crcpr_r { return static_cast<crcpr_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<crcpr_r> other) const -> ClearSet<crcpr_r> {return ClearSet<crcpr_r>(crcpr_r(Mask) | other.clear(), *this | other.set()); }
...
public:
	...
	static constexpr auto get(rxcrcr_r value) -> uint16_t { return static_cast<uint16_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<rxcrcr_r>() const {return ClearSet<rxcrcr_r>(Mask, *this);}
	constexpr auto operator|(rxcrcr_r other) const -> rxcrcr_r { return static_cast<rxcrcr_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<rxcrcr_r> other) const -> ClearSet<rxcrcr_r> {return ClearSet<rxcrcr_r>(rxcrcr_r(Mask) | other.clear(), *this | other.set()); }
...
public:
	...
	static constexpr auto get(txcrcr_r value) -> uint16_t { return static_cast<uint16_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<txcrcr_r>() const {return ClearSet<txcrcr_r>(Mask, *this);}
	constexpr auto operator|(txcrcr_r other) const -> txcrcr_r { return static_cast<txcrcr_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<txcrcr_r> other) const -> ClearSet<txcrcr_r> {return ClearSet<txcrcr_r>(txcrcr_r(Mask) | other.clear(), *this | other.set()); }
...
public:
	...
	static constexpr auto get(i2scfgr_r value) -> bool { return static_cast<bool>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<i2scfgr_r>() const {return ClearSet<i2scfgr_r>(Mask, *this);}
	constexpr auto operator|(i2scfgr_r other) const -> i2scfgr_r { return static_cast<i2scfgr_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<i2scfgr_r> other) const -> ClearSet<i2scfgr_r> {return ClearSet<i2scfgr_r>(i2scfgr_r(Mask) | other.clear(), *this | other.set()); }
...
public:
	...
	static constexpr auto get(i2scfgr_r value) -> uint8_t { return static_cast<uint8_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<i2scfgr_r>() const {return ClearSet<i2scfgr_r>(Mask, *this);}
	constexpr auto operator|(i2scfgr_r other) const -> i2scfgr_r { return static_cast<i2scfgr_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<i2scfgr_r> other) const -> ClearSet<i2scfgr_r> {return ClearSet<i2scfgr_r>(i2scfgr_r(Mask) | other.clear(), *this | other.set()); }
...
public:
	...
	static constexpr auto get(i2spr_r value) -> uint8_t { return static_cast<uint8_t>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<i2spr_r>() const {return ClearSet<i2spr_r>(Mask, *this);}
	constexpr auto operator|(i2spr_r other) const -> i2spr_r { return static_cast<i2spr_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<i2spr_r> other) const -> ClearSet<i2spr_r> {return ClearSet<i2spr_r>(i2spr_r(Mask) | other.clear(), *this | other.set()); }
...
public:
	...
	static constexpr auto get(i2spr_r value) -> bool { return static_cast<bool>((value.value() >> Offset) & Mask); }
	constexpr operator ClearSet<i2spr_r>() const {return ClearSet<i2spr_r>(Mask, *this);}
	constexpr auto operator|(i2spr_r other) const -> i2spr_r { return static_cast<i2spr_r>(*this) | other.m_value;}
	constexpr auto operator||(ClearSet<i2spr_r> other) const -> ClearSet<i2spr_r> {return ClearSet<i2spr_r>(i2spr_r(Mask) | other.clear(), *this | other.set()); }
...
template<> constexpr auto& spi1_p::cr<1>() { return cr1; }
template<> constexpr auto& spi1_p::cr<2>() { return cr2; }

template<> struct spi1_p::cr_r<1> { using type = spi1_p::cr1_r; };
template<> struct spi1_p::cr_r<2> { using type = spi1_p::cr2_r; };

static_assert(std::is_standard_layout_v<spi1_p>);
static_assert(offsetof(spi1_p, cr1) == spi1_p::cr1_r::Offset);
static_assert(offsetof(spi1_p, cr2) == spi1_p::cr2_r::Offset);
static_assert(offsetof(spi1_p, sr) == spi1_p::sr_r::Offset);
static_assert(offsetof(spi1_p, dr) == spi1_p::dr_r::Offset);
static_assert(offsetof(spi1_p, crcpr) == spi1_p::crcpr_r::Offset);
static_assert(offsetof(spi1_p, rxcrcr) == spi1_p::rxcrcr_r::Offset);
static_assert(offsetof(spi1_p, txcrcr) == spi1_p::txcrcr_r::Offset);
static_assert(offsetof(spi1_p, i2scfgr) == spi1_p::i2scfgr_r::Offset);
static_assert(offsetof(spi1_p, i2spr) == spi1_p::i2spr_r::Offset);
...
template<> constexpr auto& spi4_p::cr<1>() { return cr1; }
template<> constexpr auto& spi4_p::cr<2>() { return cr2; }

template<> struct spi4_p::cr_r<1> { using type = spi4_p::cr1_r; };
template<> struct spi4_p::cr_r<2> { using type = spi4_p::cr2_r; };

static_assert(std::is_standard_layout_v<spi4_p>);
static_assert(offsetof(spi4_p, cr1) == spi4_p::cr1_r::Offset);
static_assert(offsetof(spi4_p, cr2) == spi4_p::cr2_r::Offset);
static_assert(offsetof(spi4_p, sr) == spi4_p::sr_r::Offset);
static_assert(offsetof(spi4_p, dr) == spi4_p::dr_r::Offset);
static_assert(offsetof(spi4_p, crcpr) == spi4_p::crcpr_r::Offset);
static_assert(offsetof(spi4_p, rxcrcr) == spi4_p::rxcrcr_r::Offset);
static_assert(offsetof(spi4_p, txcrcr) == spi4_p::txcrcr_r::Offset);
static_assert(offsetof(spi4_p, i2scfgr) == spi4_p::i2scfgr_r::Offset);
static_assert(offsetof(spi4_p, i2spr) == spi4_p::i2spr_r::Offset);

inline spi1_p& spi1 = *reinterpret_cast<spi1_p*>(0x40013000);
inline spi4_p& spi2 = *reinterpret_cast<spi4_p*>(0x40003800);
inline spi4_p& spi3 = *reinterpret_cast<spi4_p*>(0x40003C00);
inline spi4_p& spi4 = *reinterpret_cast<spi4_p*>(0x40013C00);
