...
public:
	...
	static bool startClock(uint8_t pllM, uint16_t pllN, uint8_t pllP, uint8_t pllQ)
	{
		...
		flash.acr = flash_p::acr_r::prften_f() | flash_p::acr_r::icen_f() | flash_p::acr_r::dcen_f() | flash_p::acr_r::dcen_f() | flash_p::acr_r::latency_f(2); // configure flash access (2 wait state), prefetch, instruction and data cache enables.
