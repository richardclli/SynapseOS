...
private:
	...
	static constexpr uint32_t ResetValue = 0b111111111111;
...
adc_common_p& adc_common = *reinterpret_cast<adc_common_p*>(0x40012300);
adc1_p& adc1 = *reinterpret_cast<adc1_p*>(0x40012000);
